...
import { getCategoryTotal, getTotalRevenue } from "@/data/businessPlan";
    ...
    <div className="min-h-screen pb-24">
      ...
      <div className="mx-auto max-w-lg px-4 -mt-4 space-y-3">
        <div className="grid grid-cols-2 gap-3">
          ...
          <StatCard label="Entrate Totali" value={formatCurrency(revenue.actual)} sublabel={`Stimate: ${formatCurrency(revenue.estimated)}`} />
        </div>
